...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<void> _markAsRead(AppNotification notification) async {
    if (notification.isRead) {
      debugPrint('[NotificationsScreen] Notification already read, skipping');
      return;
    }
    ...
    try {
      ...
      debugPrint('[NotificationsScreen] Successfully marked as read');
                    ...
                    if (notification.bookingId != null) ...[
                      ...
                      ElevatedButton.icon(
                        onPressed: () {
                          ...
                          // You can implement this navigation based on your routing
                          debugPrint('View booking: ${notification.bookingId}');
                        },
                        style: ElevatedButton.styleFrom(
