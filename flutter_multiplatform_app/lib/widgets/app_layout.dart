...
class AppLayout extends StatelessWidget {
  ...
  List<Map<String, dynamic>> _getMenuItems(User user) {
    final items = <Map<String, dynamic>>[
      ...
      {'path': '/calendar', 'label': 'Bookings', 'icon': Icons.calendar_month, 'roles': [UserRole.ADMIN, UserRole.MANAGER]},
      {'path': '/invitations', 'label': 'Invitations', 'icon': Icons.link, 'roles': [UserRole.ADMIN, UserRole.MANAGER]},
      {'path': '/users', 'label': 'Users', 'icon': Icons.people, 'roles': [UserRole.ADMIN]},
      {'path': '/activity-logs', 'label': 'Activity Logs', 'icon': Icons.history, 'roles': [UserRole.ADMIN]},
    ];
