...
// Admin-driven password reset must enforce the same complexity as self-service
// password changes, so an admin can't set a trivially weak password for a user.
