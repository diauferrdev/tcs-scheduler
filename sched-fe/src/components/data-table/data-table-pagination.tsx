...
export function DataTablePagination<TData>({
  ...
  return (
    <div className={`flex flex-col sm:flex-row items-center gap-4 px-2 py-4 ${
      ...
      <div className="flex sm:flex-row items-center gap-6 lg:gap-8 justify-between w-full">
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <SelectContent side="top" className={theme === 'dark' ? 'bg-zinc-900 border-zinc-800 text-white' : ''}>
